...
import com.pointters.fragment.SellOrdersFragment;
...
public class CustomOfferDetailsActivity extends AppCompatActivity implements View.OnClickListener, OnApiFailDueToSessionListener, GoogleApiClient.ConnectionCallbacks, LocationListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    private TextView txtTitle, txtLinked, txtLinkedDesc, txtPrice, txtOfferDesc, txtWorkTime, txtDeliveryMethod, btnAccept;
    ...
    private void initUI() {
        ...
        btnDirection = (ImageView) findViewById(R.id.img_get_direction);
