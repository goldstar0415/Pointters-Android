...
//                    holder.txtPrice.setText(strSymbol + String.valueOf(buyOrderList.get(position).getOrder().getTotalAmountBeforeDiscount()));
//                else
...
//        private RoundedImageView notifyView;
        private TextView txtServiceDesc, txtPrice, txtPriceDesc, txtName, txtPaidOf, txtStatus, txtNoteCnt;
