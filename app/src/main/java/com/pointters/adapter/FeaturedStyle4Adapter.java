...
public class FeaturedStyle4Adapter extends RecyclerView.Adapter<FeaturedStyle4Adapter.FeaturedStyle2ViewHolder> {

    public Context context;
    public FeaturedStyle4Adapter(Context context, ArrayList<LinkedTreeMap> sections) {
    ...
    public FeaturedStyle2ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_featured_style4, parent, false);
