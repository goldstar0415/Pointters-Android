...
public class LinkServiceAdapter extends RecyclerView.Adapter<LinkServiceAdapter.MyViewHolder> {
    ...
    public LinkServiceAdapter(Context context, String username, String type, OnRecyclerViewButtonClickListener onRecyclerViewItemClickListener) {
...
//                            strPic = "https://s3.amazonaws.com" + strPic;
                        ...
                        if (searchServicesList.get(position).get_source().getPrices() != null) {
                            ...
                            if (searchServicesList.get(position).get_source().getPrices().size() > 0) {
                                ...
                                holder.txtPrices.setText(strPrice);
                            }
                        } else {
