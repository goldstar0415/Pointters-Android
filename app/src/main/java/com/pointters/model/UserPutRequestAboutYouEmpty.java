...
public class UserPutRequestAboutYouEmpty {
    ...
    public UserPutRequestAboutYouEmpty(String companyName, String firstName, String lastName, LocationRequestModel location, String phone, String profilePic) {
