...
public class GetSendServicesResponse {

    private List<SendServicesModel> docs;
    private int total;
    private int limit;
    private int page;
    private int pages;
    ...
    public List<SendServicesModel> getDocs() {
        return docs;
    }

    public void setDocs(List<SendServicesModel> docs) {
        this.docs = docs;
    }
